...
public class GLQiuPlayer extends GLPlayerView2 {
    ...
    protected boolean openVideo(){
        ...
        try {
            ...
            System.out.println("testtest getSurfaceTexture():"+getSurfaceTexture());
...
//        });
    ...
    public void onSurfaceCreated() {
        ...
        if (mState == STATE_IDLE){
            ...
            try {
                System.out.println("testtest GLQiuPlayer onSurfaceCreated getSurfaceTexture():"+getSurfaceTexture());
                mMediaPlayer.setSurface(new Surface(getSurfaceTexture()));
            } catch (IllegalStateException e) {
                handleError(e, 9005);
            }
